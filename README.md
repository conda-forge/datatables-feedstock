About datatables-feedstock
==========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/datatables-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/DataTables/DataTables
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5553&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/datatables-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `datatables` can be installed with `conda`:
...
```
mamba install datatables
```

It is possible to list all of the versions of `datatables` available on your platform with `conda`:
...
```
mamba search datatables --channel conda-forge
```
...
mamba repoquery search datatables --channel conda-forge

# List packages depending on `datatables`:
mamba repoquery whoneeds datatables --channel conda-forge

# List dependencies of `datatables`:
mamba repoquery depends datatables --channel conda-forge
```
